                  ...
                  children: [
                    ...
                    if (config.providerType == AiProviderType.gemini) ...[
                      Container(
                        ...
                        child: const Text(
                          'Built-in Gemini is already connected through Firebase. No API key is needed — generate meal plans from the Meal Plan tab.',
                          style: TextStyle(color: AppColors.textPrimary, fontSize: 13, height: 1.4),
                        ),
                      ),
                    ] else if (_isEditingKey || config.apiKey == null || config.apiKey!.isEmpty) ...[
                      TextField(
